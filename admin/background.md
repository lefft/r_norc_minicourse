...
p6.
I checked Thursday and Friday on Doodle, but I shouldn’t have any trouble getting Field Operations to let me adjust my schedule for this, and I definitely don’t want to miss this, so no need to worry about the restrictedness of the time I indicated.

p8.
in addition to all the time slots I selected, I could make it to the class anytime on Thursday afternoons or Fridays for all weeks except the last one (week of June 5), as I'll be out of the office from 12pm on Thurs June 8, through June 9. If Thurs afternoons or Fridays work best for the group I'm totally cool with that, and will just have to miss the last session. 
...
I've started a doodle poll, where you can list your availability for the first meeting: https://doodle.com/poll/vxgpdv5fhtztq8rv
...
1.	a recent version of R, preferably 3.4.0. You can install it on Windows from here (select "Download R 3.4.0 for Windows"), and on Mac from here (select "R-3.4.0.pkg"). Just accept all the defaults during installation. 
2.	a recent version of RStudio IDE, preferably 1.0.143. You can install it from here. On Windows, choose the installer called "RStudio 1.0.143 - Windows Vista/7/8/10". On Mac, choose the installer called "RStudio 1.0.143 - Mac OS X 10.6+ (64-bit)". Again, accept all defaults during installation. 
...
In case you're extra extra eager to get started, check out swirl, an excellent tutorial system for learning R. Let me know if you have any issues getting started. 
