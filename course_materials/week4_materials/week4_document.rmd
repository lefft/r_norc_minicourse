---
title: "week4 document"
author: "timothy leffel"
date: "6/8/2017"
output: html_document
---

### a tale of two files: the source and the output
...
### components of an `.rmd` source file 
...
#### normal text (with markdown formatting if desired)

After the header is the main body of the document, which mostly just contains text like this. We just type right into the file to add text to the output document. Here is where you use **markdown formatting** like asterisks for italics, like [brackets for links](LINK), and ###'s for sections and subsections. See the [R markdown cheetsheet](LINK) for pretty much all you'll need to know. 

#### inline R code

[MAKE POINT ABOUT SETTING OPTIONS...]

[DESCRIBE INLINE R CODE HERE]

[ALSO HOW COMMENTS WORK IN RMD]

[ALSO SIMPLIFY + ANNOTATE THE CSS AT THE BOTTOM]

[ALSO EXPLAIN THE HR AND BR TAGS]
...
Look through the [R Markdown cheatsheet](LINK) and the [R Markdown reference guide](LINK) for all kinds of useful chunk options. 
...
Getting your figures to look right is a trial-and-error process. Try different values for the width, height, etc., to get the size/scale the way you want it.  Also check out [some examples on the `knitr::` github page](LINK), and you'll get an idea of how things work. The main chunk options that control figure size are: 
