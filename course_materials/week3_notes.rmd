...
Before plotting, we'll make a couple of summary datasets, which will make some aspects easier moving forward. (see week 2 appendix for background on pipe-chains with `%>%` if you want to understand what's going on here)
